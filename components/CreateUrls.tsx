  ...
  return (
    <section className=" mt-2 flex w-full flex-row items-center  px-2 py-2 md:px-24 xl:px-20">
      ...
      >
        ...
        />
        <button className="flex w-full items-center justify-center rounded-lg bg-zinc-200 px-5  py-2 text-2xl backdrop-blur-2xl   transition-all duration-500  hover:bg-opacity-80 active:scale-75 dark:bg-zinc-900 dark:backdrop-blur-2xl   dark:hover:bg-opacity-80 md:w-auto">
