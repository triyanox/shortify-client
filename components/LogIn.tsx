...
const LogIn = () => {
  ...
  return (
    <section className="mt-8 flex h-screen w-full flex-col-reverse items-center justify-center gap-y-8 px-10 md:px-24 lg:mt-0 lg:h-screen lg:flex-row xl:px-20">
