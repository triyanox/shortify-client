  ...
  return (
    <section className="mt-8 mb-16 flex w-full flex-col items-center justify-center gap-8 px-10 md:px-24 xl:mt-12  xl:flex-row xl:items-start xl:px-20">
      <div className="mx-8 flex w-full flex-col items-center justify-center gap-4 sm:mx-16 lg:mx-0">
        <h1 className="mb-8 w-11/12 animate-gradient-x bg-gradient-to-r from-[#FFBA49] to-[#EF5B5B] bg-clip-text text-left text-3xl text-transparent md:w-[24rem] lg:w-[28rem]">
          Update Your Account
        </h1>
        <form
        ...
        >
          ...
          <div className="flex w-11/12 flex-col items-center justify-center gap-4 md:w-[24rem] lg:w-[28rem]">
            <button
